...
>
    ...
    <div
        bind:this={bgRef}
        class="absolute -inset-12 z-0 pointer-events-none will-change-transform hero-field"
    >
        <div
    ...
    >
        ...
        >
            ...
            <div class="overflow-hidden pb-8 -mb-8">
                <div
                    bind:this={words[1]}
                    class="hero-second-line flex items-center md:gap-6 will-change-transform pt-4"
                >
        ...
        >
            ...
            and digital products for ambitious independent teams.
        </p>
...
<style>
    .hero-field {
        ...
        mask-image: radial-gradient(ellipse at center, black 5%, transparent 72%);
    }

    @media (max-width: 767px) {
        .hero-second-line {
            font-size: min(9.2vw, 2.6rem);
            white-space: nowrap;
        }
    }
</style>
