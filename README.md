...
The distributed package includes a standard MIT `LICENSE` file and detailed provenance in `ATTRIBUTION.md`.
GSAP remains an npm dependency and is subject to its own license terms at https://gsap.com/licensing/.
