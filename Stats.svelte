<script>
	...
	const stats = [
		{ label: "Projects Shipped", limit: 32, suffix: "+", prefix: "" },
		{ label: "Design Systems", limit: 18, suffix: "+", prefix: "" },
		{ label: "Typical Sprint", limit: 6, suffix: " Weeks", prefix: "" },
		{ label: "Team Disciplines", limit: 8, suffix: "", prefix: "" },
	];
