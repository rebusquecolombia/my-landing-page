<script>
	...
	const feedbacks = [
		{
			name: "Creative lead",
			role: "Independent product team",
			text: "The motion system gives every interaction a clear purpose while keeping the experience fast and focused.",
		},
		{
			name: "Studio partner",
			role: "Design practice",
			text: "The team translated a complex visual direction into a coherent, responsive experience with careful detail.",
		},
		{
			name: "Product director",
			role: "Digital platform team",
			text: "The new experience is expressive, accessible, and easy for our team to evolve as the product grows.",
		},
	];
