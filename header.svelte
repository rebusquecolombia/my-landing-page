...
<div
    ...
    class="fixed inset-0 z-40 bg-[#0A0A0A]/85 backdrop-blur-2xl flex flex-col justify-between invisible opacity-0 px-10 pt-28 pb-10 overflow-hidden"
>
    ...
    <ul class="flex flex-col space-y-10 text-left relative z-10 my-auto">
    ...
    <div
        class="flex flex-col gap-2 text-xs font-mono text-white/40 uppercase tracking-widest relative z-10 shrink-0 sm:flex-row sm:gap-6"
    >
